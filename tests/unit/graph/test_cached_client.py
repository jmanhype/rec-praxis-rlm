"""Unit tests for CachedParseltongu eClient."""
...
from rec_praxis_rlm.graph import CachedParseltongu eClient, CallGraphNode
...
class TestCachedClient:
    """Test CachedParseltongu eClient caching behavior."""
    ...
    def test_cache_hit_memory(self, temp_cache_dir, mock_requests):
        ...
        client = CachedParseltongu eClient(cache_dir=temp_cache_dir)
    ...
    def test_cache_hit_disk(self, temp_cache_dir, mock_requests):
        ...
        client1 = CachedParseltongu eClient(cache_dir=temp_cache_dir)
        ...
        client2 = CachedParseltongu eClient(cache_dir=temp_cache_dir)
        ...
        # Should only have made health check, not call graph query
    ...
    def test_cache_ttl_expiration(self, temp_cache_dir, mock_requests):
        ...
        mock_requests.get.side_effect = [
            Mock(status_code=200),  # Health check
            call_graph_response,     # First query
            Mock(status_code=200),  # Health check for second client
            call_graph_response      # Second query (after expiration)
        ]

        # Client with 1 second TTL
        client = CachedParseltongu eClient(cache_dir=temp_cache_dir, cache_ttl=1)
        ...
        # Should have made 2 health checks + 2 call graph queries
    ...
    def test_clear_cache(self, temp_cache_dir, mock_requests):
        ...
        # Should have made HTTP request again
